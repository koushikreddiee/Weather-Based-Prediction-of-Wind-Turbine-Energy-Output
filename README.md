...
|                 |                         |
| --------------- | ----------------------- |
| **Team ID**     | LTVIP2026TMIDS24572     |
| **Team Leader** | Hemanth Kumar Kotyada |
| **Team Member** | Kunam Gopi Reddy    |
| **Team Member** | Kishtipati Koushik Reddy             |
| **Team Member** | Kolla Vidya Sri Valli              |
...
```bash
git clone https://github.com/koushikreddiee/Weather-Based-Prediction-of-Wind-Turbine-Energy-Output/tree/main
```
